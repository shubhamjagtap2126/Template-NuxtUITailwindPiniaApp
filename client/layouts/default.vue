      ...
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16">
          ...
          <NuxtLink to="/" class="flex items-center space-x-3 group">
            <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <nav class="hidden md:flex items-center space-x-1">
            <NuxtLink
              ...
              :key="link.to"
              :to="link.to"
              class="nav-link relative px-4 py-2 rounded-lg font-medium transition-all duration-300 group"
              :class="{
            ...
            >
              ...
              {{ link.label }}
              <!-- Active indicator -->
              <span v-if="$route.path === link.to" class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-blue-500 rounded-full"></span>
            </NuxtLink>
          </nav>
          ...
          <div class="p-6">
            ...
            <nav class="space-y-2">
              <NuxtLink
                ...
                :key="link.to"
                :to="link.to"
                class="flex items-center space-x-3 p-3 rounded-lg font-medium transition-all duration-200 group"
                :class="{
                  'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20': $route.path === link.to,
                  'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800/50': $route.path !== link.to,
                }"
            ...
            <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
              <div class="flex items-center justify-between">
                ...
                <UButton :icon="isDark ? 'i-lucide-moon' : 'i-lucide-sun'" color="gray" variant="outline" size="sm" @click="toggleTheme">
                  {{ isDark ? 'Dark' : 'Light' }}
                </UButton>
              </div>
            </div>
      ...
      <div class="container mx-auto px-4 py-16 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="md:col-span-2">
            ...
            <p class="text-gray-300 mb-6 max-w-md">Building the future of web applications with cutting-edge technology and beautiful design.</p>
        ...
        <div class="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            <NuxtLink to="/terms" class="text-gray-400 hover:text-white text-sm transition-colors duration-200"> Terms of Service </NuxtLink>
          </div>
        </div>
      </div>
    </footer>
